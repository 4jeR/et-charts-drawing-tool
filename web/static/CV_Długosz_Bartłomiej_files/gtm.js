...
"resource": {
  ...
  "macros":[{
      ...
      "vtp_fieldsToSet":["list",["map","fieldName","exp","value",["macro",5]],["map","fieldName","userId","value",["macro",6]]],
      "vtp_useHashAutoLink":false,
      "vtp_decorateFormsAutoLink":false,
      "vtp_enableLinkId":false,
      "vtp_dimension":["list",["map","index","4","dimension",["macro",7]]],
  ...
  "tags":[{
      ...
      "consent":["list"],
      "once_per_event":true,
      "vtp_html":"\n\u003Cscript\u003E!function(b,e,f,g,a,c,d){b.fbq||(a=b.fbq=function(){a.callMethod?a.callMethod.apply(a,arguments):a.queue.push(arguments)},b._fbq||(b._fbq=a),a.push=a,a.loaded=!0,a.version=\"2.0\",a.queue=[],c=e.createElement(f),c.async=!0,c.src=g,d=e.getElementsByTagName(f)[0],d.parentNode.insertBefore(c,d))}(window,document,\"script\",\"https:\/\/connect.facebook.net\/en_US\/fbevents.js\");fbq(\"init\",\"628834620591421\");fbq(\"track\",\"PageView\");\u003C\/script\u003E\n",
      ...
      "consent":["list"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003E(function(){window.ldfdr=window.ldfdr||{};(function(b,c,e,a){function f(g){var d=b.createElement(c);d.src=g;setTimeout(function(){a.parentNode.insertBefore(d,a)},1)}a=b.getElementsByTagName(c)[0];f(e)})(document,\"script\",\"https:\/\/sc.lfeeder.com\/lftracker_v1_DzLR5a59gj6aBoQ2.js\")})();\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":138
...
A[C.type])A[C.type](C)};t=function(){B();return w(z())}}();return{append:function(q){k+=q},uh:t,di:function(q){for(var u;(u=t())&&(!q[u.type]||!1!==q[u.type](u)););},clear:function(){var q=k;k="";return q},ei:function(){return k},stack:[]}}var b=function(){var k={},l=this.document.createElement("div");l.innerHTML="<P><I></P></I>";k.ii="<P><I></P></I>"!==l.innerHTML;l.innerHTML="<P><i><P></P></i></P>";k.hi=2===l.childNodes.length;return k}(),c=/^<([\-A-Za-z0-9_]+)((?:\s+[\w\-]+(?:\s*=?\s*(?:(?:"[^"]*")|(?:'[^']*')|[^>\s]+))?)*)\s*(\/?)>/,
...
v):q.removeAttribute(w)}function t(q,u){var v=q.ownerDocument;e(this,{root:q,options:u,Hb:v.defaultView||v.parentWindow,Ra:v,cc:nc("",{$f:!0}),Wc:[q],ud:"",vd:v.createElement(q.nodeName),Db:[],Ja:[]});r(this.vd,"proxyof",0)}t.prototype.write=function(){[].push.apply(this.Ja,arguments);for(var q;!this.Wb&&this.Ja.length;)q=this.Ja.shift(),"function"===typeof q?this.hg(q):this.Ed(q)};t.prototype.hg=function(q){var u={type:"function",value:q.name||q.toString()};this.qd(u);q.call(this.Hb,this.Ra);this.De(u)};
...
u++;w.push(x.text.replace(/(\/?>)/," data-ps-id="+A+" $1"));"ps-script"!==x.S.id&&"ps-style"!==x.S.id&&z.push("atomicTag"===x.type?"":"<"+x.tagName+" data-ps-proxyof="+A+(x.Gb?" />":">"))}}else w.push(x.text),z.push("endTag"===x.type?x.text:"")});return{ji:q,raw:v.join(""),$d:w.join(""),sh:z.join("")}};t.prototype.Hh=function(){for(var q,u=[this.vd];b(q=u.shift());){var v=1===q.nodeType;if(!v||!r(q,"proxyof")){v&&(this.Wc[r(q,"id")]=q,r(q,"id",null));var w=q.parentNode&&r(q.parentNode,"proxyof");
w&&this.Wc[w].appendChild(q)}u.unshift.apply(u,h(q.childNodes))}};t.prototype.Jg=function(q){var u=this.cc.clear();u&&this.Ja.unshift(u);q.src=q.S.src||q.S.Ph;q.src&&this.Db.length?this.Wb=q:this.qd(q);var v=this;this.Ih(q,function(){v.De(q)})};t.prototype.Kg=function(q){var u=this.cc.clear();u&&this.Ja.unshift(u);q.type=q.S.type||q.S.TYPE||"text/css";this.Kh(q);u&&this.write()};t.prototype.Kh=function(q){var u=this.gg(q);this.Pg(u);q.content&&(u.styleSheet&&!u.sheet?u.styleSheet.cssText=q.content:
u.appendChild(this.Ra.createTextNode(q.content)))};t.prototype.gg=function(q){var u=this.Ra.createElement(q.tagName);u.setAttribute("type",q.type);d(q.S,function(v,w){u.setAttribute(v,w)});return u};t.prototype.Pg=function(q){this.Ed('<span id="ps-style"/>');var u=this.Ra.getElementById("ps-style");u.parentNode.replaceChild(q,u)};t.prototype.qd=function(q){q.kh=this.Ja;this.Ja=[];this.Db.unshift(q)};t.prototype.De=function(q){q!==this.Db[0]?this.options.error({message:"Bad script nesting or script finished twice"}):
(this.Db.shift(),this.write.apply(this,q.kh),!this.Db.length&&this.Wb&&(this.qd(this.Wb),this.Wb=null))};t.prototype.Ih=function(q,u){var v=this.fg(q),w=this.Ch(v),z=this.options.Rf;q.src&&(v.src=q.src,this.Ah(v,w?z:function(){u();z()}));try{this.Og(v),q.src&&!w||u()}catch(x){this.options.error(x),u()}};t.prototype.fg=function(q){var u=this.Ra.createElement(q.tagName);d(q.S,function(v,w){u.setAttribute(v,w)});q.content&&(u.text=q.content);return u};t.prototype.Og=function(q){this.Ed('<span id="ps-script"/>');
...
return null},Ad=!1;if(H.querySelectorAll)try{var Bd=H.querySelectorAll(":root");Bd&&1==Bd.length&&Bd[0]==H.documentElement&&(Ad=!0)}catch(a){}var vd=Ad;var Pd={},L=null,Qd=Math.random();Pd.B="GTM-P89SGK";Pd.Sb="920";Pd.Mh="";var Rd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Sd="www.googletagmanager.com/gtm.js";
var Td=Sd,Ud=null,Vd=null,Wd="//www.googletagmanager.com/a?id="+Pd.B+"&cv=119",Xd={},Yd={},Zd=function(){var a=L.sequence||1;L.sequence=a+1;return a};
...
Z.a.tg=["google"],function(){function a(k){h.push(k);1<h.length||I(function(){var l=h.join(",");h=[];Jl({event:"gtm.triggerGroup","gtm.triggers":l})})}function b(k,l){var p=d[l],n=p.indexOf(k);-1!==n&&(p.splice(n,1),p.length||a(l))}function c(k){I(k.vtp_gtmOnSuccess);var l=k.vtp_uniqueTriggerId,p=k.vtp_triggerIds,n=k.vtp_firingId;if(k.vtp_isListeningTag){var r=e[n];r?b(n,r):f.push(n)}else{d[l]=p;for(var t=0,q;q=p[t];t++)e[q]=l;for(var u=0;u<f.length;u++)b(f[u],l)}}var d={},e={},f=[],h=[];Z.__tg=c;Z.__tg.b="tg";Z.__tg.g=!0;Z.__tg.priorityOverride=0}();
...
Z.a.opt=["google"],function(){var a,b=function(c){var d={};if(c.vtp_gaSettings){var e=c.vtp_gaSettings;m(ym(e.vtp_fieldsToSet,"fieldName","value"),d);c.vtp_gaSettings=null;e.vtp_fieldsToSet=void 0;var f=m(e);c=m(c,f)||{}}m(ym(c.vtp_fieldsToSet,"fieldName","value"),d);var h=zh(c.vtp_functionName);if(va(h)){h.r=!0;var k="",l="";c.vtp_setTrackerName&&"string"===typeof c.vtp_trackerName?""!==c.vtp_trackerName&&(l=c.vtp_trackerName,k=l+"."):(l="gtm"+Zd(),k=l+".");var p={name:!0,clientId:!0,sampleRate:!0,
...
(A&&p[y]||!A&&void 0===p[y])){var C=n[y]?Fa(z[y]):z[y];"anonymizeIp"!==y||C||(C=void 0);x[y]=C;B++}return B},t={name:l};r(d,t,!0);var q={"&gtm":hi(!0)};r(d,q,!1);var u=encodeURI(Q("https:","http:","//www.google-analytics.com/"+(c.vtp_useDebugVersion?"u/analytics_debug.js":"analytics.js"),!!d.forceSSL));h("create",c.vtp_trackingId,t);h(k+"set",q);h(k+"require",c.vtp_optimizeContainerId,{dataLayer:"dataLayer"});h(c.vtp_gtmOnSuccess);h(k+"require","render");a||(a=!0,W(u,function(){return xh().loaded||
c.vtp_gtmOnFailure()},c.vtp_gtmOnFailure));var v=X("dataLayer"),w=v&&v.hide;w&&(w.end||!0===w["GTM-P89SGK"])&&(w[c.vtp_optimizeContainerId]=!0)}else I(c.vtp_gtmOnFailure)};Z.__opt=b;Z.__opt.b="opt";Z.__opt.g=!0;Z.__opt.priorityOverride=0}();
...
(b.vtp_enableCrossDomain&&!1===b.vtp_acceptIncoming||(b.vtp_enableCrossDomain||Xf())&&og(a,k));lg(k);qg(["aw","dc"],k);zg(h,k);var l=e;if(b.vtp_enableCrossDomainFeature&&b.vtp_enableCrossDomain&&b.vtp_linkerDomains){var p=b.vtp_linkerDomains.toString().replace(/\s+/g,"").split(",");pg(a,p,b.vtp_urlPosition,!!b.vtp_formDecoration,l)}var n=Il(D.N);Li(!1,void 0!=n&&!1!==n);b.vtp_enableUrlPassthroughFeature&&b.vtp_enableUrlPassthrough&&sg()})}();
...
Z.a.hl=["google"],function(){function a(f){return f.target&&f.target.location&&f.target.location.href?f.target.location.href:Fl()}function b(f,h){Tc(f,"hashchange",function(k){var l=a(k);h({source:"hashchange",state:null,url:Hl(l),R:Gl(l)})})}function c(f,h){Tc(f,"popstate",function(k){var l=a(k);h({source:"popstate",state:k.state,url:Hl(l),R:Gl(l)})})}function d(f,h,k){var l=h.history,p=l[f];if(va(p))try{l[f]=function(n,r,t){p.apply(l,[].slice.call(arguments,0));k({source:f,state:n,url:Hl(Fl()),
R:Gl(Fl())})}}catch(n){}}function e(){var f={source:null,state:X("history").state||null,url:Hl(Fl()),R:Gl(Fl())};return function(h){var k=f,l={};l[k.source]=!0;l[h.source]=!0;if(!l.popstate||!l.hashchange||k.R!=h.R){var p={event:"gtm.historyChange","gtm.historyChangeSource":h.source,"gtm.oldUrlFragment":f.R,"gtm.newUrlFragment":h.R,"gtm.oldHistoryState":f.state,"gtm.newHistoryState":h.state,"gtm.oldUrl":f.url,"gtm.newUrl":h.url};f=h;Jl(p)}}}(function(f){Z.__hl=f;Z.__hl.b="hl";Z.__hl.g=!0;Z.__hl.priorityOverride=
0})(function(f){var h=X("self");if(!Ol("hl")){var k=e();b(h,k);c(h,k);d("pushState",h,k);d("replaceState",h,k);Pl("hl")}I(f.vtp_gtmOnSuccess)})}();
...
[];k.firstChild;)r.push(k.removeChild(k.firstChild));d.insertBefore(k,null);a(k,r,l,h)()}else d.insertBefore(k,null),l()}else f()}catch(t){I(h)}}}var b=function(d,e,f){jh(function(){var h,k=L;k.postscribe||(k.postscribe=oc);h=k.postscribe;var l={done:e},p=H.createElement("div");p.style.display="none";p.style.visibility="hidden";H.body.appendChild(p);try{h(p,d,l)}catch(n){I(f)}})};var c=function(d){if(H.body){var e=
